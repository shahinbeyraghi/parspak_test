...
Route::middleware('auth.basic')
    ->get('server/run-process', 'Monitoring\ServerStatusController@runProcess')->name('run-process');

Route::middleware('auth.basic')
    ->get('users/files-name', 'User\FileManagementController@listFiles')->name('files-name');
